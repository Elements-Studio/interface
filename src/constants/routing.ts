...
export const COMMON_BASES: ChainCurrencyList = {
  ...
  [SupportedChainId.MAINNET]: [ExtendedStar.onChain(SupportedChainId.MAINNET), STAR[SupportedChainId.MAINNET], FAI[SupportedChainId.MAINNET], XUSDT[SupportedChainId.MAINNET]],
